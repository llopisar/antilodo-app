...
export default async function KitchenTasksPage({ searchParams }: Props) {
  ...
  return (
    <div className="space-y-4">
      <ModuleHeader title="Kitchen Tasks" description="Internal task assignment, ownership, and completion tracking." />
      ...
      <FilterForm action="/kitchen/tasks" query={params.q} status={params.status} statusOptions={["TODO", "IN_PROGRESS", "DONE", "BLOCKED"]} />
