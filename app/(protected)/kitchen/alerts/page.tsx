...
export default async function KitchenAlertsPage({ searchParams }: Props) {
  ...
  return (
    <div className="space-y-4">
      <ModuleHeader title="Kitchen Alerts" description="Incidents, severity tracking, and escalation management." />
      ...
      <FilterForm action="/kitchen/alerts" query={params.q} status={params.status} statusOptions={["OPEN", "ACKNOWLEDGED", "RESOLVED", "ESCALATED"]} />
