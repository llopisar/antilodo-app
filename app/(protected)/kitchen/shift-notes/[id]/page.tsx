...
export default async function KitchenShiftNoteDetailPage({ params }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      <Link className="text-sm underline" href="/kitchen/shift-notes">Back to shift notes</Link>
    </div>
  );
}
