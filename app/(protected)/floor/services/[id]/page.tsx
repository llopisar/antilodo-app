...
export default async function FloorServiceDetailPage({ params }: Props) {
  ...
  return (
    <div className="space-y-4">
      <ModuleHeader title={service.name} description="Service detail, status updates, and floor coordination context." />
      ...
      <Link className="text-sm underline" href="/floor/services">Back to services</Link>
    </div>
  );
}
