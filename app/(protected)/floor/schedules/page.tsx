...
export default async function FloorSchedulesPage({ searchParams }: Props) {
  ...
  return (
    <div className="space-y-4">
      <ModuleHeader title="Floor Schedules" description="Shift planning and coverage tracking for floor service operations." />
      ...
      <FilterForm action="/floor/schedules" query={params.q} status={params.status} statusOptions={["FLOOR_MANAGER"]} />
      ...
      <div className="grid gap-3">
        ...
        {schedules.map((schedule) => (
          <ListCard
            ...
            href={`/floor/schedules/${schedule.id}`}
